	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				names: [],
				types: [],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/berita.json.js'))
			},
			{
				type: 'page',
				id: "products",
			...
			},
			{
				...
				names: [],
				types: [],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/api/products/products.json.js'))
			},
			{
				type: 'endpoint',
				...
				names: ["slug"],
				types: [null],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/api/products/_slug_.json.js'))
			},
			{
				type: 'endpoint',
				id: "api/rss.xml",
				...
				names: [],
				types: [],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/api/rss.xml.ts.js'))
			},
			{
				type: 'endpoint',
				...
				names: [],
				types: [],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/api/berita/berita.json.js'))
			},
			{
				type: 'endpoint',
				...
				names: ["slug"],
				types: [null],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/api/berita/_slug_.json.js'))
			},
			{
				type: 'endpoint',
				id: "api/posts.json",
				...
				names: [],
				types: [],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/api/posts/index.json.ts.js'))
			},
			{
				type: 'endpoint',
				...
				names: [],
				types: [],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/api/posts/count.json.ts.js'))
			},
			{
				type: 'endpoint',
				id: "api/ukm/ukm.json",
				...
				names: [],
				types: [],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/api/ukm/ukm.json.js'))
			},
			{
				type: 'endpoint',
				...
				names: ["slug"],
				types: [null],
				load: () => Promise.resolve().then(() => require('../server/entries/endpoints/api/ukm/_slug_.json.js'))
			},
			{
				type: 'page',
				id: "ukm",
