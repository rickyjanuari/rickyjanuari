...
var uses_svelte_svelte_type_style_lang = "";
const css = {
...
const load = async () => {
  const Uses = await Promise.resolve().then(() => __toESM(require("../../chunks/uses-02d1fd96.js")));
  return { props: { Uses: Uses.default } };
};
const Uses_1 = (0, import_index_2749e1b7.c)(($$result, $$props, $$bindings, slots) => {
  let { Uses } = $$props;
...
${(0, import_index_2749e1b7.v)(import_Main_5d179e14.M, "Main").$$render($$result, {}, {}, {
    default: () => {
      return `<div class="${"uses compressed-content"}">${(0, import_index_2749e1b7.v)(Uses || import_index_2749e1b7.m, "svelte:component").$$render($$result, {}, {}, {})}</div>`;
    }
  })}`;
});
