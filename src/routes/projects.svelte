  ...
  <div class="projects compressed-content double-wide">
    ...
    <article>
      <div class="sticky">
        ...
        <ul>
          ...
          <li> 
            <a href="https://github.com/rickyjanuari/sveltekit-blog-starter">GitHub repo</a>
          </li>
        </ul>  
      </div>
    ...
    <article>
      <div class="sticky">
        ...
        <p>You can also find my work on <a href="https://github.com/rickyjanuari">GitHub</a> (although truth be told I don't really bother curating it there at all.)</p>
      </div>
      <ul>
        <li>
        ...
        <li>
          A <a href="https://github.com/rickyjanuari/flywheel-cloud-wp-load-fix">WordPress plugin</a> to help make various other plugins and theme compatible with <a href="https://getflywheel.com/cloud-platform/">Flywheel's cloud platform</a>
        </li>
        <li>
