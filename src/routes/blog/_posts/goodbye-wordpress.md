...
<SideNote>
This post mentions Gridsome frequently, but <a href="https://rickyjanuari.com/blog/converting-from-gridsome-to-sveltekit">this site is actually built with SvelteKit now</a>. It looks and works mostly the same, but the underlying tech is a bit different.
</SideNote>
